...
rmarkdown::render(here::here("slides", "2-mlm.Rmd"), params = list(
  author = c("Waylon Howard"),
  date = format(Sys.time(), '%B %d, %Y'),
  location = "Webinar"))

pagedown::chrome_print(here::here("slides", "2-mlm.html"), 
                       output = here::here("slides", "2-mlm.pdf") )

#devtools::install_github("jirilukavsky/pdf2pptx")
# Convert the PDF to PowerPoint
pdf2pptx::pdf2pptx(here::here("slides", "2-mlm.pdf"),
                   here::here("slides", "2-mlm.pptx") )
